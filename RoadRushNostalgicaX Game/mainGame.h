...
int initialFrame = 0;
int heroPositionX = 520, heroPositionY = 50, bikeFaceNow = -1;
...
char bike[7][40] = {    "image\\mainGame\\heroBike\\1.bmp", 
						"image\\mainGame\\heroBike\\2.bmp",
						"image\\mainGame\\heroBike\\3.bmp",
						"image\\mainGame\\heroBike\\4.bmp",
						"image\\mainGame\\heroBike\\5.bmp",
						"image\\mainGame\\heroBike\\6.bmp",
						"image\\mainGame\\heroBike\\7.bmp" };
...
void renderMainBike(){
	bikeFaceNow++;
	bikeFaceNow %= 7;
	iShowBMP2(heroPositionX, heroPositionY, bike[bikeFaceNow], 255);
}
...
void showScore(string givenScore){
	...
	iSetColor(0, 255, 0);
	iText(25, 772, "Score :", GLUT_BITMAP_HELVETICA_18);
	iSetColor(255, 255, 255);
	iText(40, 750, score_string, GLUT_BITMAP_HELVETICA_18);
}
