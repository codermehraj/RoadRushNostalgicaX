...
void showHighScore(){
	...
	iSetColor(0, 0, 0);
	iText(380, 350, highestScoreString, GLUT_BITMAP_TIMES_ROMAN_24);
	iText(330, 410, ScorerName, GLUT_BITMAP_TIMES_ROMAN_24);
}
...
void showCurrentScore(string givenScore, int scoreToSave){
	...
	iSetColor(0,0,0);
	iText(300,320, score_string, GLUT_BITMAP_TIMES_ROMAN_24);
